...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'Internet das Coisas (75h) | SENAI-SP') ?></title>
    <meta name="description" content="Portal oficial da Unidade Curricular de Internet das Coisas (IoT) - SENAI-SP. Teoria integral, simulações Tinkercad, circuitos 3D e atividades práticas.">
